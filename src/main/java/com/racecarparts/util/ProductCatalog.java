...
public class ProductCatalog {
        ...
        products = new HashMap<>();
                ...
                products.put("Part 101", new EngineBlock(2000.00, "Part 101", 1, "/images/engine1.jpg", "305 Engine Block Steel"));
                products.put("Part 102", new EngineBlock(2500.00, "Part 102", 1, "/images/engine2.jpg", "305 Engine Block Aluminum"));
                products.put("Part 103", new EngineBlock(3000.00, "Part 103", 1, "/images/engine3.jpg", "350 Engine Block Steel"));
                products.put("Part 104", new EngineBlock(3500.00, "Part 104", 1, "/images/engine4.jpg", "350 Engine Block Aluminum"));
                products.put("Part 105", new EngineBlock(4000.00, "Part 105", 1, "/images/engine5.jpg", "410 Engine Block Steel"));
                products.put("Part 106", new EngineBlock(4500.00, "Part 106", 1, "/images/engine6.jpg", "410 Engine Block Aluminum"));
